      ...
      return (
        ...
        >
          <Icon
            ...
            size={15}
          />
          <Text style={{ fontFamily: "breg", marginHorizontal: 5 }}>
            {element}
          </Text>
        </View>
      );
      ...
      <View>
        ...
        >
          ...
          >
            ...
            />
            <View
              style={{ alignSelf: "center", marginLeft: "4%", marginTop: 5 }}
            >
              <Text
                style={{
                  fontSize: 18,
          ...
          >
            ...
            <View style={{ flexDirection: "column", width: "50%" }}>
              ...
              >
                <Text style={{ fontFamily: "breg" }} numberOfLines={1}>
                  {pname}
                </Text>
              </View>
              <View
          ...
          >
            <Image
              ...
              source={{
                uri: `https://maps.googleapis.com/maps/api/staticmap?center=${latitude},${longitude}&zoom=14&size=600x800&maptype=roadmap&markers=color:red%7Clabel:S%7C${latitude},${longitude}&key=AIzaSyBhsYbmkBufF5SW-nb2tEsHKSV5A6J1_u8`,
              }}
            />
          </View>
          <Button
...
PendingScreen.navigationOptions = ({ navigation }) => {
  return {
    ...
    headerLeft: () => (
      <Icon
        name="arrow-left"
        style={{ paddingLeft: 15, marginTop: 10, color: "black" }}
        onPress={() => {
          navigation.navigate({ routeName: "Appointments" });
        }}
        size={25}
      />
    ),
