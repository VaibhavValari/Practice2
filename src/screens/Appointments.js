            ...
            <View style={styles.conatiner1}>
              ...
              >
                ...
                >
                  <Text
                    numberOfLines={1}
                    style={{ fontSize: 13, fontFamily: "breg" }}
                  >
                    id {element.bookingId}
                  </Text>
                </View>
    ...
    >
      ...
      >
        <View style={{ marginLeft: 18, alignSelf: "flex-start" }}>
          <Text style={{ fontFamily: "bbol", fontSize: 22, color: "black" }}>
            Your Appointments
          </Text>
        </View>
        <Searchbar
        ...
        >
          <Icon color="grey" name="sliders" size={20} />
        </View>
        <View
          style={{
        ...
        >
          <Text style={{ fontFamily: "bbol", fontSize: 21, color: "black" }}>
            Active
          </Text>
        </View>
        <ScrollView
      ...
      >
        <Text style={{ fontSize: 20, fontFamily: "bbol", color: "black" }}>
          Completed
        </Text>
      </View>
